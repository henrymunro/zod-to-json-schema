...
| **enableReadonly**?: boolean                                                       | Enable the translation of the zod `.readonly()` function to a `readOnly: true` property in the output JSONSchema type. Defaults to false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
